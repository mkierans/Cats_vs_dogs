...
#    model.add(Dropout(0.05))
    ...
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='th')) #128x128
...
#    model.add(Dropout(0.1))
    model.add(Convolution2D(nb_filters*2, nb_row=3, nb_col=3, 
                            ...
                            dim_ordering='th')) 
#    model.add(Dropout(0.1))
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='th')) #64x64
    ...
    model.add(Convolution2D(nb_filters*4, nb_row=3, nb_col=3, 
                            border_mode='same', activation='relu', 
                            dim_ordering='th'))
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='th')) #32x32
    model.add(Dropout(0.1))
    ...
    model.add(Convolution2D(nb_filters*8, nb_row=3, nb_col=3, 
                            ...
                            dim_ordering='th'))
    model.add(Dropout(0.2))
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='th')) #16x16
    ...
    model.add(Convolution2D(nb_filters*16, nb_row=3, nb_col=3, 
                            ...
                            dim_ordering='th'))   
    model.add(Dropout(0.2))
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='th')) #8x8
    ...
    model.add(Convolution2D(nb_filters*16, nb_row=3, nb_col=3, 
                            border_mode='same', activation='relu',
                            dim_ordering='th'))
    model.add(MaxPooling2D(pool_size=(2, 2), dim_ordering='th')) #4x4
#    model.add(Convolution2D(nb_filters*4, nb_row=3, nb_col=3, 
#                            border_mode='same', activation='relu',
#                            subsample = (2, 2))) #4x4
